...
def test_llm_config_generation_kwargs():
    ...
    assert mistral_config.organization == "MISTRAL"
    ...
    assert anthropic_config.organization == "ANTHROPIC"
    ...
    assert cohere_config.organization == "COHERE"
    ...
    assert hf_config.organization == "HF"
    ...
    assert openai_config.organization == "OPENAI"

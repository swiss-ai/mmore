...
Check your processing configuration file, for example [`examples/process/config.yaml`](https://github.com/EPFLiGHT/mmore/blob/master/examples/process/config.yaml), and make sure it includes the distributed settings such as:

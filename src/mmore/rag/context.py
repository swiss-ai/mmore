"""
Multimodal context for RAG: formatted text plus image paths (and optionally loaded images).
"""
...
# Type for a loaded image (PIL.Image or compatible)
ImageT = TypeVar("ImageT")


@dataclass
class MultimodalContext:
    """Context for the LLM: text plus optional image paths and loaded images."""
...
def load_images_from_paths(
    ...
    """Load PIL Images from file paths. Skips missing/invalid files. Returns at most max_images."""
    try:
